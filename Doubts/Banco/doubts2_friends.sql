...
CREATE TABLE `friends` (
  ...
  KEY `id_user_idx` (`id_user1`),
  KEY `id_user2_idx` (`id_user2`),
  CONSTRAINT `id_user1` FOREIGN KEY (`id_user1`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_user2` FOREIGN KEY (`id_user2`) REFERENCES `user` (`id_user`) ON DELETE NO ACTION ON UPDATE NO ACTION
